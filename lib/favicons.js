...
function generateIcons (loader, imageFileStream, pathPrefix, query, callback) {
  ...
  config.appleIcon["meta[name='apple-mobile-web-app-status-bar-style']"] = `<meta name='apple-mobile-web-app-status-bar-style' content='${query.icons.appleStatusBarStyle}'>`;
  console.log(config);
